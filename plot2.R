# Plot 2 for Exploratory Analysis HW #1
...
if(!file.exists(full_path_csv)) {
    ...
    # Determine if the zip file exist
    if(!file.exists(full_path_zip)) {
        ...
        #If Zip file exist, unzip to the data sub folder
...
# sub-folders)
setwd(curr_folder)
#Make a PNG copy of the Global Active Power plot using Graphic Device
png(filename="plot2.png",width=480, height=480,units='px')
# Create plot of Global Active Power over the time and date
